...
def main():
    ...
    parser.add_argument( "-p",   "--paths",                  help="Output path condition information.", choices=['smt2-complete', 'smt2-path-only', 'sat-complete', 'dimacs-complete'])
    ...
    global_params.PRINT_PATHS = args.paths if args.paths else False
